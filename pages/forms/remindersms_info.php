          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Reminder SMS</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;">
                          <option selected="selected">Sent</option>
                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>New York</td>
                          <td>
                            <button class="btn btn-success">Sent on 12/08/2023<br>at 8.00p.m.</button>
                           </td>
                          <td>
                            <button class="btn btn-success">Sent on 12/08/2023<br>at 8.00p.m.</button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>New York</td>
                          <td>
                            <button class="btn btn-danger">Not Sent</button>
                          </td>
                          <td>
                            <button class="btn btn-danger">Not Sent</button>
                          </td>
